...
import { MediaEvent } from "./media_events/peer/peer";
import { MediaEvent as MediaEvent1 } from "./media_events/server/server";
...
export interface PeerMessage {
  ...
  peerMediaEvent?: MediaEvent | undefined;
  serverMediaEvent?: MediaEvent1 | undefined;
}
...
function createBasePeerMessage(): PeerMessage {
  return {
    ...
    rtcStatsReport: undefined,
    peerMediaEvent: undefined,
    serverMediaEvent: undefined,
  };
}
...
export const PeerMessage: MessageFns<PeerMessage> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.peerMediaEvent = MediaEvent.decode(reader, reader.uint32());
          continue;
        }
        case 6: {
          if (tag !== 50) {
  ...
  toJSON(message: PeerMessage): unknown {
    ...
    if (message.serverMediaEvent !== undefined) {
      obj.serverMediaEvent = MediaEvent1.toJSON(message.serverMediaEvent);
    }
    return obj;
  },
